  ...
  <main>
    <section>
      ...
      <form role="search" onSubmit={handleSearch}>
        <div>
            <svg  width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" ><path stroke="none" d="M0 0h24v24H0z" fill="none" /><path d="M3 10a7 7 0 1 0 14 0a7 7 0 1 0 -14 0" /><path d="M21 21l-6 -6" /></svg>
            <input 
                name="search" 
                type="text" 
    ...
    <section>
      <header>
          <h1>Por que DevJobs?</h1>
          <p>Devjobs es la principal bplsa de trabajo para desarrolladores. Cenectamos a los desarrolladores con las mejores empresas del mundo.</p>
      </header>
      ...
      <footer>
          ...
          <article>
              ...
              <p>Obten el salario que mereces con nuesttra calculadora de salarios</p>
          </article>
      </footer>
    </section>
  </main>
